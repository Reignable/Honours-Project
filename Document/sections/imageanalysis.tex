\subsection{Image Analysis}
	...
	\subsubsection{Digital Camera Operation}
		...
		\\\\
		\todo{Make this paragraph not introduce IA and IP again, talk about integer values are manipulated in these}
		These integer values in the image data can be manipulated to change the visual appearance of the image or analysed or compared to neighbouring cells in order to locate objects represented in the image. These processes are known as image processing and image analysis.
