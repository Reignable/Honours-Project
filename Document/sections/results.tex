...
\subsection{Deviation from Plan}
	...
	\subsubsection{Measurement Process}
		...
		\paragraph{Colour Quantification}
			% Initially used manual ref points of uniform colour
			% Moved onto real ref point
			% Colors off, making it not work
			% Simulated uniform color through quantification
