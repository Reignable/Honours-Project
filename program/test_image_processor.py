...
class TestImageProcessor(TestCase):
    ...
    RS_IMAGE_PATH = '100_rs.jpg'
    FOX_IMAGE_PATH = '100_fox.jpg'
    ...
    def test_show_image_normal(self):
        ...
        image = cv2.imread(self.RS_IMAGE_PATH)
    ...
    def test_get_measurement_mm_normal(self):
        self.assertIsInstance(self.image_processor.get_measurement(self.RS_IMAGE_PATH), float)

    def test_get_measurement_mm_in_range(self):
        expected = 29.0
        measurement = self.image_processor.get_measurement(self.RS_IMAGE_PATH)
